 ...
 * is "normal" (400) on both lines — the bundled font (see lib/fonts.js)
 * only ships Regular and Bold TTFs, so 400 is the actual lightest weight
 * available; anything above ~500 was quietly resolving to the Bold file
 * via fontconfig's nearest-weight matching, which is why it read heavier
 * than intended. Letter-spacing is cut back from the original all-caps
 * tracking (1.5/1.8), which reads as too loose on title-case text.
 */
