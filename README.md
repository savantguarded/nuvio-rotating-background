...
| `POOL` | `trending` | `trending` (US-scoped: trending/week movies filtered to English-language, TV filtered to US origin_country) \| `now_playing` \| `airing_today` \| `popular` — `trending` is the active default |
